...
class FedExInxpress extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
	\Magento\Shipping\Model\Carrier\CarrierInterface
{
	/**
	 * @var string
	 */
	protected $_code = 'fedexinxpress';
	...
	{
		return ['fedexinxpress' => $this->getConfigData('name')];
	}
		...
		if ($request->getAllItems()) {
			...
			foreach ($rates as $ixpRate) {
				...
				if ($shippingPrice != 0) {
					...
					$method->setCarrier('fedexinxpress');
