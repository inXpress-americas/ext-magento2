...
class TNTInxpress extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
	\Magento\Shipping\Model\Carrier\CarrierInterface
{
	/**
	 * @var string
	 */
	protected $_code = 'tntinxpress';
	...
	{
		return ['tntinxpress' => $this->getConfigData('name')];
	}
